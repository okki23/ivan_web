...
class Mcrud extends CI_Model {
	...
	var $tbl_mahasiswa	 = 'tbl_mahasiswa';
	...
	public function update_bim($where, $data)
	{
		$this->db->update('tbl_bimbingan', $data, $where);
		return $this->db->affected_rows();
	}
	...
	public function delete_kelas_by_id($id)
	{
		$this->db->where('kdkelas', $id);
		$this->db->delete('tbl_kelas');
	}
	public function delete_jurusan_by_id($id)
	{
		$this->db->where('kdjurusan', $id);
	...
	public function get_mahasiswa_by_nim($id)
	{
