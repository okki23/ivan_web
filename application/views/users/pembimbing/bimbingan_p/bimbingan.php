    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        ...
        <div class="panel-body">
                ...
                ?>
                <a href="users/bimbingan_p/t" class="btn btn-primary"><i class="icon-plus22"></i> Bimbingan</a>
                  ...
                  <tbody>
                      ...
                      ?>
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="users/bimbingan_p/d/<?php echo $baris->kdbimbingan; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                              <!-- <a href="users/bimbingan_p/h/<?php echo $baris->kdbimbingan; ?>" class="btn btn-danger btn-xs" onclick="return confirm('Anda yakin?')"><i class="icon-trash"></i></a> -->
                            </td>
                          </tr>
                      <?php
                          }
