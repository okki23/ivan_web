...
<style>
  ...
  $(document).ready(function() {
        chart1 = new Highcharts.Chart({
           ...
           title: {
              text: 'Grafik Nilai Magang - Total'
           },
           xAxis: {
              categories: ['Jurusan']
           },
           yAxis: {
              ...
              foreach ($v_jurusan->result() as $baris) {
                ...
                $nilai = $this->db->query("SELECT AVG(tbl_nilai.nilai) AS total FROM tbl_mahasiswa
                                            INNER JOIN tbl_kelas ON tbl_kelas.kdkelas=tbl_mahasiswa.kdkelas
                                            INNER JOIN tbl_jurusan ON tbl_jurusan.kdjurusan=tbl_kelas.kdjurusan
                                            INNER JOIN tbl_penempatan ON tbl_penempatan.nim=tbl_mahasiswa.nim
    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
          <div class="panel-body">
            <fieldset class="content-group">
              <legend class="text-bold"><i class="icon-stats-bars2"></i> GRAFIK HASIL MAGANG MAHASISWA/legend>
              <div id ="grafik"></div>
            </fieldset>
          </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="panel panel-flat">
            <div class="panel-body">
                <?php
                $total_mahasiswa = $this->db->query("SELECT * FROM tbl_mahasiswa
                                            INNER JOIN tbl_penempatan ON tbl_penempatan.nim=tbl_mahasiswa.nim
                                            WHERE
                                                tbl_penempatan.tahun='$thn'")->num_rows();

                $total_nilai = $this->db->query("SELECT AVG(tbl_nilai.nilai) AS total FROM tbl_mahasiswa
                                            INNER JOIN tbl_penempatan ON tbl_penempatan.nim=tbl_mahasiswa.nim
                                            INNER JOIN tbl_nilai ON tbl_nilai.kdpenempatan=tbl_penempatan.kdpenempatan
                                              WHERE
                                                  tbl_penempatan.tahun='$thn'
                ...
                <div class="col-md-7">
                  ...
                  <b>Jml. Mahasiswa : <?php echo number_format($total_mahasiswa, 0,",","."); ?></b>
                </div>
            </div>
        </div>
        <div class="panel panel-flat">
