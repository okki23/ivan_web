              ...
              <fieldset class="content-group">
                ...
                <form class="form-horizontal" action="" method="post">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9">
                      <input type="text" name="nip" class="form-control" value="" id="valuepassword" placeholder="NIP" maxlength="21" required>
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <?php
                  ...
                  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input type="text" name="nim" class="form-control" value="" id="valuepassword" placeholder="Masukkan NIM" maxlength="11" required>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-lg-3">Password</label>
                      <div class="col-lg-9">
                        <input type="text" name="text" class="form-control"   value="" readonly="true" id="password" placeholder="Password" maxlength="11" required>
                      </div>
                    </div>
